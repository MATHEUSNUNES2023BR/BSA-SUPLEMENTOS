                ...
                <div className="col-md-12 col-lg-4 redes d-flex flex-column align-items-center align-items-sm-center mt-5 mt-md-4 mt-lg-0">
                    ...
                    <div className="row mb-1">
                        <div className='whatsapp'> 
                            <a target='blank' href="https://wa.me/message/JQBOEZC7LHOAA1"><img typeof='svg' className='img-fluid'  src="../public/rodape/whatsapp.svg" alt="" /> </a>
                        </div>
                        <div className='instagram'>
                            <a target='blank' ><img typeof='svg' className='img-fluid' src="../public/rodape/instagram.svg" alt="" /></a> 
                        </div>
                    </div>
